        ...
        <div className="relative h-full my-10 mx-[10%] flex items-start justify-center flex-col md:flex-row gap-6">
          <div className="size-full md:w-1/2 text-left flex flex-col justify-center items-start">
            <motion.h1
              ...
              className="my-0 text-4xl xl:text-4xl text-shadow-2xs text-shadow-sky-300 font-bold tracking-wide text-gray-800 uppercase">
            ...
            <motion.h1
              ...
              className="my-0 text-4xl xl:text-4xl text-shadow-2xs text-shadow-sky-300 font-bold tracking-wide text-white uppercase text-right">
