...
export default function RegisterForm() {
    ...
    return (
        <div className="flex-col flex w-3/4">
            ...
            <p className="text-xs mt-10 text-center text-gray-500">By clicking <b>Create account</b>, you agree to Linktree&apos;s <span className="italic">Terms and Conditions</span> and confirm you have read our <span className="italic">Privacy Notice.</span> You may receive offers, news and updates from us.</p>
