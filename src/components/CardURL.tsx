    ...
    return (
        <div className='w-full border border-gray-300 shadow-lg rounded-3xl mt-4 p-2 px-16'>
            ...
            <div className='text-sm mb-4 flex w-full'>
                <div className="w-10/12 flex justify-start items-center cursor-pointer" onClick={handleEdit.EditUrl}>
                    {editUrl ? (
                        <Input
                            type='text'
                            name='url'
                        ...
                        <>
                            <div className="italic break-words whitespace-normal w-full">{url}</div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 ml-3">
                                <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                            </svg>
                        </>
